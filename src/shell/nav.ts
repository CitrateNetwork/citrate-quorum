...
export const NAV: NavGroup[] = [
  {
    ...
    items: [
      ...
      { id: "governance", label: "Governance", register: "charter", built: true,
        p1: "M12 3 L4 7 V12 C4 16.5 7.5 20.5 12 21 C16.5 20.5 20 16.5 20 12 V7 Z", p2: "M9 12 L11 14 L15 10" },
      { id: "agents", label: "Agents", register: "instrument", built: true,
  ...
  },
  {
    label: "Meet",
    items: [
      { id: "rooms", label: "Rooms", register: "instrument", built: true,
      ...
      { id: "meetings", label: "Meetings", register: "charter", built: true,
        p1: "M6 3 H18 A2 2 0 0 1 20 5 V21 L12 17 L4 21 V5 A2 2 0 0 1 6 3 Z", p2: "M8 8 H16 M8 11 H13" },
      { id: "calendar", label: "Calendar", register: "charter", built: true,
