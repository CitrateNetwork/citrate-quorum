...
| **S5.4** | Minutes composed from the governed record + ratification through the `SignatureCeremony` | Ratification is an HIC-1 act with its own decision record; a ratified meeting is immutable; an inquorate meeting cannot be ratified |
